"""
ops.py — Production Operational Safety Module for AceGold Casino Bot
=====================================================================
Provides:
...
Design rules:
  ...
  • All main.py/sportsbook.py hooks are optional — if ops fails, bot continues.
...
_RL_LIMITS = {
    ...
    "sb_bet":      (3,  15),    # 3 bets per 15 s
    "sb_cashout":  (2,  10),    # 2 cashout attempts per 10 s
...
def alert_owner(message: str, level: str = "WARN"):
    ...
    try:
        ...
        text = f"{prefix} <b>[{level}] AceGold Casino Alert</b>\n\n{message}"
